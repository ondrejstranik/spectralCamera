...
from HSIplasmon.algorithm.gridSuperPixel import GridSuperPixel
import HSIplasmon as hsi
import pickle

class CalibrateRamanImages():
    ...
    def saveClass(self, classFile= None):
        ...
        if classFile is None:
            ...
            fullFile = hsi.dataFolder + '\\' + classFile
        else:
            fullFile = classFile
    ...
    def loadClass(self,classFile=None):
        ...
        if classFile is None:
            fullFile = hsi.dataFolder + '\\' + self.DEFAULT['classFile']
        else:
